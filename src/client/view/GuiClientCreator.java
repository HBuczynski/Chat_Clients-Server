...
public class GuiClientCreator {
	...
	private void initializeNorthPanel()
	{
		...
		guiObjects_.userLabel.setLocation(30, 10);
		...
		guiObjects_.usernameField.setLocation(140, 15);
		...
		guiObjects_.connect.setSize(110, 25);
		guiObjects_.connect.setLocation(330, 57);
		
		guiObjects_.disconnect = new JButton("DISCONNECT");
		guiObjects_.disconnect.setEnabled(false);
		guiObjects_.disconnect.setSize(110, 25);
		guiObjects_.disconnect.setLocation(445, 57);
